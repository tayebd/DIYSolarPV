...
In this project we focus mainly on the counties that get their service from Georgia Power, the 4.2 million customers who are served by EMCs face less hurdles in setting up a solar PV array and connecting to the grid. The EMCs are generally more helpful to their customer/owners.  The proposed DIY system is around 5 Kw system with smart micro-inverters from EnPhase and solar panels from one of the best solar panel manufacturers, the balance of system components are provided as an estimate as they vary depending on the installation. The ROI (return on investment) of the system is more 20% and is further enhanced if the home or business owner can take advantage of the ITC tax credit. 
...
## Is Worth it to sell electricity to the Georgia Power grid?
